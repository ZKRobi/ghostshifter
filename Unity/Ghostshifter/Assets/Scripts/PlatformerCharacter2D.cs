...
public class PlatformerCharacter2D : MonoBehaviour
{
    ...
    [SerializeField]
    private float m_BaseSpeed = 10f;                    // Character is running this quickly alll the time
    [Range(0, 1)]
    [SerializeField]
    ...
    [SerializeField]
    private float m_BoostWeight = 1f; //Maximum boost level
    [SerializeField]
    private float m_timer = 0; //Boost time remaining / cooldown timer
    ...
    private void Awake()
    {
        ...
        m_Anim[1] = transform.Find("Frog").GetComponent<Animator>();
